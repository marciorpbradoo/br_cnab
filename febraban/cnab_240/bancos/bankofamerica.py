...
class BankOfAmerica240(Cnab240):

    def __init__(self):
        super(Cnab240, self).__init__()
        from cnab240.bancos import bankofamerica
        self.bank = bankofamerica

    def _prepare_header(self):
        vals = super(BankOfAmerica240, self)._prepare_header()
    ...
    def _prepare_segmento(self, line):
        vals = super(BankOfAmerica240, self)._prepare_segmento(line)
